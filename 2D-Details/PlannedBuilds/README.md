...
**In-flight ideas:** `orientation-presets/` (predates and is independent of the rebuild) and `premium-textbox/` (a ground-up rebuild of the 2D-mode annotation/text-box tool — being built 2026-05-30).
